  ...
  return (
    <footer className="footer" >
      <div className="topdiv">
        <div>
        <div><img className="logo" src="" alt="" /></div>
        <div><img src="https://th-i.thgim.com/public/incoming/1ktib6/article65665132.ece/alternates/LANDSCAPE_320/PTI07_20_2022_000126B.jpg" alt="" /></div>
        </div>
...
export const Footer1 = () => {
   ...
   return (
     <div>
       ...
       <hr className="hr"/>
       <div className="terms">© 2022 The Hindu </div>
